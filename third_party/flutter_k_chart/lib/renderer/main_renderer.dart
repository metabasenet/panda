...
//    //画阴影
  ...
  void drawCandle(CandleEntity curPoint, Canvas canvas, double curX) {
    ...
    if (open > close) {
      ...
      final difference = open - close;
      canvas.drawRect(
          Rect.fromLTRB(
              curX - r, close, curX + r, difference < 1.0 ? open + 1 : open),
          chartPaint);
      canvas.drawRect(
      ...
      canvas.drawRect(
          Rect.fromLTRB(
              curX - r, open, curX + r, open == close ? close + 1.0 : close),
          chartPaint);
      canvas.drawRect(
          Rect.fromLTRB(curX - lineR, high, curX + lineR, low), chartPaint);
    }
  ...
  void drawRightText(canvas, textStyle, int gridRows) {
    ...
    for (var i = 0; i <= gridRows; ++i) {
      ...
      tp.paint(canvas, Offset(chartRect.width - tp.width - 5, y));
    }
  }
