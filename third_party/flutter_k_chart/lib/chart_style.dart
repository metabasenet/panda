...
class ChartColors {
  ...
  //背景颜色
  static const Color bgColor = Color(0xff1b1e26);
  static const Color kLineColor = Color(0xff4C86CD);
  static const Color gridColor = Color(0xff676f83);
  ...
  static const Color dnColor = Color(0xffff4a4a);
  static const Color upColor = Color(0xff0aaa6b);
  ...
  static const Color minTextColor = Color(0xFFff4a4a); //最大最小值的颜色
  static const Color maxTextColor = Color(0xFF0aaa6b); //最大最小值的颜色

  //深度颜色
  static const Color depthBuyColor = Color(0xff0aaa6b);
  static const Color depthSellColor = Color(0xffff4a4a);
  static const Color depthTextColor = Color(0xff60738E);

  //选中后显示值边框颜色
  static const Color markerBorderColor = Color(0xff6C7A86);

  //选中后显示值背景的填充颜色
  static Color markerBgColor = Color(0xff0D1722).withOpacity(0.8);

  //实时线颜色等
  static const Color realTimeBgColor = Color(0xFF1b1e26);
  static const Color rightRealTimeTextColor = Color(0xFFccd3e6);
  static const Color realTimeTextBorderColor = Color(0xffdddddd);
  static const Color realTimeTextColor = Color(0xFFccd3e6);

  //实时线
  static const Color realTimeLineColor = Color(0xFF1b1e26);
  static const Color realTimeLongLineColor = Color(0xFFccd3e6);
...
class ChartStyle {
  ...
  static const double bottomDateHigh = 0.0;
